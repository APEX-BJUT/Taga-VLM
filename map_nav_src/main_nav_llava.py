...
from r2r_llava.agent import GMapNavAgent
from r2r_llava.data_utils import construct_instrs
from r2r_llava.env import R2RNavBatch
from r2r_llava.parser import parse_args
from tensorboardX import SummaryWriter
from utils.data import ImageFeaturesDB
from utils.distributed import all_gather, init_distributed, is_default_gpu, merge_dist_results
from utils.logger import print_progress, timeSince, write_to_record_file
...
def build_dataset(args, rank=0, is_test=False):
    ...
    # val_env_names = ['Validation_Non-residential_Basic','Validation_Non-residential_Scene','Validation_Residential_Basic']
...
def train(args, train_env, val_envs, aug_env=None, rank=-1):
    ...
    if args.dataset == "r4r":
        best_val = {"val_unseen_sampled": {"spl": 0.0, "sr": 0.0, "state": ""}}
...
# def test_llava():
#     pretrained = "/root/liujiaxing/LLaVA-NeXT/model_zoo/llava-onevision-qwen2-0.5b-si"
...
#     image_path = "/root/liujiaxing/LLaVA-NeXT/docs/ov_chat_images/test4.png"
...
#     question = DEFAULT_IMAGE_TOKEN + "\nHow many views are there in this image, and can you discribe them one by one form right to left?"
#     # question = DEFAULT_IMAGE_TOKEN + "\nwhich view has a paint on the wall"
