...
class Qwen2SdpaGraphAttention(Qwen2SdpaAttention):
    """
    Qwen2 attention module using torch.nn.functional.scaled_dot_product_attention with graph structure support.
    This module inherits from `Qwen2SdpaAttention` and adds graph-aware attention capabilities.
    """
...
class Qwen2Model(Qwen2PreTrainedModel):
    ...
    def forward(
        ...
        self._attn_implementation = "sdpa" #set_attn_mask
