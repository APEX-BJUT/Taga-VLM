...
class LlavaQwenForCausalLM(Qwen2ForCausalLM, LlavaMetaForCausalLM):
    ...
    def __init__(self, config):
        ...
        self.graph_sprels = None
        # self.expanded_distance_matrix = None
    ...
    def forward(
        ...
        if dpo_forward:
            ...
            return super().forward(
                ...
                output_hidden_states=output_hidden_states,
                return_dict=return_dict,
                graph_sprels=self.graph_sprels
            )
    ...
    def generate(
        ...
        **kwargs,
        ...
        #    attention_mask += self.graph_sprels

        if images is not None:
            (inputs, position_ids, attention_mask, _, inputs_embeds, _, expanded_distance_matrix) = self.prepare_inputs_labels_for_multimodal(inputs, position_ids, attention_mask, None, None, images, modalities, image_sizes=image_sizes,nav_data=self.graph_sprels)
            # print(f"\n\n\nexpanded_distance_matrix: {expanded_distance_matrix.sum()}\n\n\n")
            self.graph_sprels = expanded_distance_matrix
